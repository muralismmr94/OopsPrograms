...
const fs = require('fs');
var utility = require('./companyShare');
/**
 *@description :function definition
 */
function companySharesMain() {
    /**
    ...
    try {
         ...
         */
        var stockCompany1 = fs.readFileSync("/home/admin1/Desktop/myjavascript/oopsprograms/JSONfiles/stockCompany.json", "utf8");
        var stockCustomer1 = fs.readFileSync("/home/admin1/Desktop/myjavascript/oopsprograms/JSONfiles/stockCustomer.json", "utf8");
        /**
