    ...
    try {
        ...
        */
        while (ch != 4) {
            ...
            /**
             * @description : Taken user input and passed the value here to switch case and executed equalent value case.
             */
            switch (ch) {
                case 1:
...
/**
 * @description : calling the main function here.
 */
main();